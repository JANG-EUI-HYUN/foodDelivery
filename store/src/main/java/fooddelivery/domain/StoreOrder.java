...
import fooddelivery.domain.Coupon;
import fooddelivery.domain.TimeSaleMenu;
...
public class StoreOrder  {
    ...
    public void onPrePersist(){
        ...
        coupon.publishAfterCommit();



        TimeSaleMenu timeSaleMenu = new TimeSaleMenu(this);
        timeSaleMenu.publishAfterCommit();
    ...
    public static void orderCancelAlarm(OrderCanceled orderCanceled){
